...
WORD_IMAGE_RADIUS = math.ceil(
    DEFAULT_WORD_RADIUS * SYLLABLE_SCALE_MAX * OUTER_CIRCLE_SCALE_MAX) + 4 * HALF_LINE_DISTANCE
SYLLABLE_IMAGE_RADIUS = math.ceil(DEFAULT_WORD_RADIUS * SYLLABLE_SCALE_MAX) + 4 * HALF_LINE_DISTANCE

DOT_RADIUS = DEFAULT_WORD_RADIUS / 20
MIN_DOT_RADIUS = 0
